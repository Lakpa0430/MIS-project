        ...
        <section class="shopping-cart">
            ...
            <table>
                ...
                <tbody>
                    ...
                    // $select_image = mysqli_query($conn, "SELECT image FROM products WHERE name='$pname'");
                    $grand_total = 0;
                    ...
                    ?>
                    <tr>
                        <td><img src="../admin/uploaded_img/<?php echo $fetch_cart['image']; ?>" height="100" alt="">
                        </td>
                        ...
                        <!-- <td><a href="cart.php?remove=<?php echo $fetch_cart['id']; ?>"
                                onclick="return confirm('remove item from cart?')" class="Buy-btn"> <i
                                    class="fas fa-trash"></i> Buy</a></td> -->
                    </tr>
                    <?php

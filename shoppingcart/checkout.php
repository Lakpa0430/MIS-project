...
if (isset($_POST['stripeToken'])) {
    ...
    $detail_query = mysqli_query($conn, "INSERT INTO `orders`(name, number, email, method, city, country, total_products, total_price, username) VALUES('$name','$number','$email','card','$city','$country','$total_product','$price_total','$username')") or die('query failed');
    ...
    <div class="container">
        ...
        <section class="checkout-form">
            ...
            <form action="" method="post">
                ...
                <script src="https://checkout.stripe.com/checkout.js" class="stripe-button" data-key="<?php echo $publishableKey ?>" data-amount="<?php echo $grand_total * 100; ?>" data-name="Pay With Card" data-image=" ./images/1.jpg" data-currency="usd" data-email=" ">
                        </script>
